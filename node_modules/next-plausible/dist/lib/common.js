...
export const getScriptPath = (options, ...modifiers) => {
    var _a, _b;
...
export const getRemoteScriptName = (selfHosted) => selfHosted ? 'plausible' : 'script';
export const getDomain = (options) => { var _a; return (_a = options.customDomain) !== null && _a !== void 0 ? _a : plausibleDomain; };
export const getApiEndpoint = (options) => {
    var _a, _b;
